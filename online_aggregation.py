...
def systemTierAgg(ob_agg_data, rules_list, delta, window_clock_size, raw_data_len):
    ...
    evaluation(result, raw_data_len)
    return result

def evaluation(eval_data, raw_data_len):
...
def main(raw_data, rules_list, delta) -> None:
    ...
    _ = systemTierAgg(sensorTierProcessedDate, rules_list, delta, window_clock_size, raw_data_len)
